...
const FloatingActionButton = () => {
  ...
  return (
    <div className="fixed bottom-3 right-3 sm:bottom-6 sm:right-6 z-40">
      {showFloatingButtons && (
        ...
        >
          <motion.a
            ...
            className="w-14 h-14 bg-white text-[#B8FF3B] rounded-full flex items-center justify-center shadow-lg border-2 border-[#B8FF3B] hover:bg-[#B8FF3B] hover:text-black transition-colors duration-200"
            target="_blank"
      ...
      {open && (
        ...
        >
          ...
          >
            ...
            <motion.button
              className="text-[#B8FF3B] absolute top-3 right-3 px-1 py-1 rounded-full focus:outline-none hover:bg-[#B8FF3B]/10 transition-colors duration-200"
            ...
            <div className="flex flex-col gap-5">
              <motion.div 
                className="flex items-center justify-between p-4 border-2 border-[#B8FF3B] rounded-xl hover:bg-[#B8FF3B]/5 transition-colors duration-200"
                whileHover={{ scale: 1.05 }}
              >
                <a
                  href="https://wa.me/+919920540535"
                  className="flex items-center text-[#B8FF3B] cursor-pointer"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <FaWhatsapp size={24} />
      ...
      <motion.button
        className="w-14 h-14 bg-[#B8FF3B] text-black rounded-full flex items-center justify-center shadow-lg focus:outline-none hover:bg-[#A6E635] transition-colors duration-200"
        onClick={() => {
