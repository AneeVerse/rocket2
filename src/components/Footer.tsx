        ...
        <div className="mb-12">
          ...
          <div className="flex justify-center mt-12">
            <div className="flex space-x-6">
              ...
              {/* Email */}
              <a href="mailto:rocketsinghentps@gmail.com" target="_blank" rel="noopener noreferrer" className="text-white hover:text-gray-300 transition-colors duration-200 p-2 hover:bg-gray-800 rounded-full">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
