        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <h1 className="text-4xl lg:text-5xl xl:text-6xl font-bold text-black mb-6 leading-tight">
              ...
              <span className="text-[#B8FF3B] block">Quick, Legal, Secure</span>
            </h1>
            
            <p className="text-lg lg:text-xl text-gray-600 mb-8 leading-relaxed max-w-2xl mx-auto lg:mx-0">
              Update your PAN card details after legal name change due to marriage, divorce, or other reasons. Expert assistance with NSDL/UTIITSL portals, document preparation, and complete application support for hassle-free PAN card correction.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <Link href="/pan-card#pan-card-contact">
          ...
          <div className="relative mt-8 lg:mt-0">
            <div className="relative rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
              <Image
                src="/images/pancard/pancard.png"
                alt="PAN Card Name Change Services"
                width={600}
                height={400}
                className="w-[680px] h-[550px] object-cover"
                priority
              />
              
              {/* Overlay Badge */}
              <div className="absolute top-4 left-4 bg-[#B8FF3B] text-black px-3 py-1 rounded-full text-sm font-semibold">
                ✓ Trusted Service
              </div>
            </div>
            ...
            <div className="absolute -bottom-6 -left-6 bg-white rounded-xl shadow-lg p-4 border border-gray-100">
              <div className="flex items-center space-x-3">
                <div className="w-12 h-12 bg-[#B8FF3B]/20 rounded-lg flex items-center justify-center">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-500">PAN Cards Updated</div>
                </div>
              </div>
            </div>
            ...
            <div className="absolute -top-6 -right-6 bg-white rounded-xl shadow-lg p-4 border border-gray-100">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <div className="text-2xl font-bold text-black">7-15</div>
