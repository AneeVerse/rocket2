...
export default function NameChangeReasonPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="bg-white py-16 lg:py-24 mt-15">
            ...
            <div className="flex-1 lg:pr-8">
              ...
              <div className="flex flex-row gap-2 sm:gap-4">
                 <Link 
                   ...
                   className="flex-1"
                 >
                   <button className="w-full bg-[#B8FF3B] hover:bg-[#A3E635] text-black px-4 sm:px-8 py-3 rounded-lg font-semibold transition-colors duration-200 shadow-sm hover:shadow-md flex items-center justify-center gap-2 text-sm sm:text-base">
                 ...
                 <Link href="/#contact" className="flex-1">
                   <button className="w-full border-2 border-[#B8FF3B] text-black hover:bg-[#B8FF3B] hover:text-black px-4 sm:px-8 py-3 rounded-lg font-semibold transition-colors duration-200 text-sm sm:text-base">
                     Apply Now
                   </button>
                 </Link>
               </div>
            ...
            <div className="max-w-2xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link 
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center bg-[#B8FF3B] text-black font-bold px-8 py-4 rounded-lg hover:bg-[#A3E635] transition-colors duration-200 gap-2"
                >
                ...
                <Link 
                  ...
                  className="inline-flex items-center justify-center bg-white text-black font-medium px-8 py-4 rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors duration-200 gap-2"
                >
